                        ...
                        <tr>
                            <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                                <div style="text-align:center; margin:0 15px 34px 15px">
                                    ...
                                    <p style="width: 250px; margin: auto; margin-bottom: 30px; font-size: 14px;font-family: 'Poppins', sans-serif;">Please click the button below to verify your new email address.</p>
                                    ...
                                    <p style="width: 250px; margin: auto; margin-bottom: 30px; font-size: 14px;font-family: 'Poppins', sans-serif;">
