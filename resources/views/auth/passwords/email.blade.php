            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4"> <span class="text-muted">Enter your email address and we'll send you an email
                        ...
                        <form method="POST" id="formAuthentication" class="mb-3" action="{{ route('password.email') }}">
                            ...
                            <div class="mb-3 ">
                                ...
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required placeholder="Enter your register email" autocomplete="email" autofocus>
